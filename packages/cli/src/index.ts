...
/**
 * @minions-oss-releases/cli — CLI for Minions Oss-releases
 *
...
import { customTypes } from '@minions-oss-releases/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Oss-releases'));
        console.log(chalk.dim('Release definitions, changelogs, and publish receipts'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-oss-releases/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-oss-releases/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-oss-releases')}`);
