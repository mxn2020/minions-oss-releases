# Manual Setup Steps for Minions Oss-releases
...
Go to **GitHub → mxn2020/minions-oss-releases → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-oss-releases` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-oss-releases-web`
- **GitHub repo**: `mxn2020/minions-oss-releases`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `oss-releases.minions.wtf`

### Documentation
- **Netlify site name**: `minions-oss-releases-docs`
- **GitHub repo**: `mxn2020/minions-oss-releases`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `oss-releases.minions.help`

### Blog
- **Netlify site name**: `minions-oss-releases-blog`
- **GitHub repo**: `mxn2020/minions-oss-releases`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `oss-releases.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `oss-releases.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `oss-releases.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `oss-releases.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-oss-releases/sdk`](https://www.npmjs.com/package/@minions-oss-releases/sdk)
- CLI: [`@minions-oss-releases/cli`](https://www.npmjs.com/package/@minions-oss-releases/cli)
...
Your package: [`minions-oss-releases`](https://pypi.org/project/minions-oss-releases/)
...
| Item | Value |
|------|-------|
| Project | `minions-oss-releases` |
| SDK (npm) | `@minions-oss-releases/sdk` |
| CLI (npm) | `@minions-oss-releases/cli` |
| Python (PyPI) | `minions-oss-releases` |
| GitHub | `github.com/mxn2020/minions-oss-releases` |
| Docs domain | `oss-releases.minions.help` |
| Blog domain | `oss-releases.minions.blog` |
| App domain | `oss-releases.minions.wtf` |
